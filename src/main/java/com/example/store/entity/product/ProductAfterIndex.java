...
@Table(
        name = "product_after_index",
        indexes = {
                @Index(name = "idx_category_title_after_index", columnList = "category_id, title")
        }
)
public class ProductAfterIndex {
...
/*
    ...
    public ProductAfterIndex(ProductAfterIndex p) {
        this.id = p.getId();
